const fs = require('fs');
const PARAMS_PATH = './data/parameters.json';
const LIST_PATH = './data/socket-parameters-list.json';
const AIS_PATH = './data/ais.json';
        ...
        fs.readFile(PARAMS_PATH, (err, dataAis) => {
            ...
            fs.readFile(LIST_PATH, (err, dataPars) => {
                ...
                try {
                    ...
                    const {eco1:parametersEco1 =[],eco2:parametersEco2=[],eco3:parametersEco3=[]} = parameters;
